...
// var breakLen = document.querySelector('.breakLen');
// console.log(breakLen);

// breakMinus.addEventListener('click',function(e){
// 	console.log(e)
// 	breakLen.innerHTML = Number(breakLen.innerHTML) - 1;
// })

// breakPlus.addEventListener('click',function(e){
// 	console.log(e)
// 	breakLen.innerHTML = Number(breakLen.innerHTML) + 1;
// })
...
// var sessionLen = document.querySelector('.sessionLen');

// sessionMinus.addEventListener('click',function(e){
// 	console.log(e)
// 	sessionLen.innerHTML = Number(sessionLen.innerHTML) - 1;
// 	document.querySelector('#countDown').innerHTML = sessionLen.innerHTML + ' 00';
// })

// sessionPlus.addEventListener('click',function(e){
// 	console.log(e)
// 	sessionLen.innerHTML = Number(sessionLen.innerHTML) + 1;
// 	document.querySelector('#countDown').innerHTML = sessionLen.innerHTML + ' 00';
// })
...
// var sessionTimer = document.querySelector('.sessionTimer');

// sessionTime.addEventListener('click', function(e){
// 	console.log(e);
// 	breakTimer.style.display = 'none';
// 	sessionTimer.style.display = 'block';
// })

// breakTime.addEventListener('click', function(e){
// 	console.log(e);
...
// 	var str = document.querySelector('#countDown').innerHTML;
// 	if(str.length != 5) {
// 		str = '0' + str;
// 	}
// 	var sec = (str.slice(0,2)*60) + Number(str.slice(3))
// 	console.log(sec);
// 	var a = new Date().getTime();
// 	var futureTime = new Date(a + sec*1000);
